...
dbcc page(1,1,1,3)
go
-- bstat is now 0x109. The BUF_DIRTY bit is cleared. Now 0x100 is set which is BUF_CHKGEN which is
-- internally used by checkpoint to avoid flusing the same buffer more than once.
