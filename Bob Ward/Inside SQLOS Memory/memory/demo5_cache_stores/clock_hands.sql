...
select mcch.type, mcch.cache_address, dateadd(ms, -1 * (@ts_now - mcch.last_tick_time), GetDate()) as LastClockMovementTime,
...
where clock_hand = 'HAND_EXTERNAL'
order by LastClockMovementTime desc
go
